 ...
 * @author LENOVO
 */
public class ManHinhChaoDialog extends javax.swing.JDialog {

    
    public ManHinhChaoDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        init();
    }
        ...
        new Timer(20, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
               ...
               if(value < 100){
                   ...
                   ManHinhChaoDialog.this.dispose();
               }
            }
        }).start();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Quản Lý Cửa Hàng Máy Tính");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManHinhChaoDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ManHinhChaoDialog dialog = new ManHinhChaoDialog(new javax.swing.JFrame(), true);
